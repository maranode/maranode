...
- [x] **Password reset flow** — No self-service or admin-triggered password reset email. Admins can set a new password via API but there is no notification mechanism.
